...
--]]
	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				{category = "RandomAlcohol", percent = 33, min = 1, max = 3 },
				--{category = "RandomClothes", percent = 25 },
				{category = "RandomFlashlight", percent = 33 },
				{category = "RandomHat", percent = 34 },
			},
		},
...

		{
			...
			classes =
			{
				...
				-- basic (46)
				{ class = "guide_structures_wood_bridges_1", percent = 6 },
				{ class = "guide_structures_wood_ramps_1", percent = 3 },
				{ class = "guide_structures_wood_stairs_1", percent = 4 },
				{ class = "guide_structures_wood_traps_1", percent = 6 },
				{ class = "guide_structures_wood_walkways_1", percent = 6 },
				{ class = "guide_structures_wood_walls_1", percent = 8 },
				{ class = "guide_structures_wood_roofs", percent = 6 },
		...
		-- Gnomes
		{
			...
			classes =
			{
				...
				{ class = "gnome_creep", percent = 17 },
				{ class = "gnome_gold", percent = 1 },
				{ class = "gnome_silver", percent = 2 },
				{ class = "gnome_standard_a", percent = 30 },
				{ class = "gnome_standard_b", percent = 30 },
				{ class = "gnome_standard_c", percent = 17 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "HazmatMask", percent = 25 },
				{ class = "GasMask", percent = 10 },
				{ category = "RandomEyes", percent = 10 },
				{ class = "FannyPackGray", percent = 10 },
				{ class = "FannyPackRed", percent = 15 },
				{ class = "FannyPackRedBlue", percent = 10 },
...

		{
			...
			classes =
			{
				...
				{ class = "RainJacketOrangeBlue", percent = 10},
				{ class = "RainJacketYellow", percent = 10},
...

		{
			...
			classes =
			{
				...
				{ category = "RandomPistol", percent = 20 },
				{ class = "AmcoinLedger", percent = 15 },
				{ category = "RandomCraftingGuide", percent = 15 },
				--{ category = "RandomClothes", percent = 79 },
				{ category = "RandomNormalRepairKit", percent = 30 },
			},
		},
