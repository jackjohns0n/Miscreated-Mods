...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomDrink")
...
local categoryItemToAdjust1 = FindInTable(categoryToAdjust.classes, "category", "RandomSeeds")
