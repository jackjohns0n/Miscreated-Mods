...
local newItem = { class = "12Gaugex16_Beanbag_AA12", percent= 17, }

local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "12GaugeAA12Mags")
local categoryItemToAdjust = FindInTable(categoryToAdjust.classes, "class", "12Gaugex8_Beanbag_AA12")
...
categoryItemToAdjust.percent = 16
