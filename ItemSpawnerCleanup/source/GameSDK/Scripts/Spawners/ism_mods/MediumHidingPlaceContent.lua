...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "MediumHidingPlaceContent")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomAmmo")
...
categoryItemToAdjust2.percent = 40
