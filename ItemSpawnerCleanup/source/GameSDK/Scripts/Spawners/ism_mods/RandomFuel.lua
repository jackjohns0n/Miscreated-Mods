...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomFuel")
local categoryItemToAdjust = FindInTable(categoryToAdjust.classes, "class", "small_generator") -- could also search for fitting "class" instead "category"
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "PropaneTank")
