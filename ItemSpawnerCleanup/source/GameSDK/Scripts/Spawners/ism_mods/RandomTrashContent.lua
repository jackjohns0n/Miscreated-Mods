...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomTrashContent")
...
local categoryItemToAdjust3 = FindInTable(categoryToAdjust.classes, "category", "RandomSeeds")
local categoryItemToAdjust4 = FindInTable(categoryToAdjust.classes, "class", "BalaclavaBlack")
...
categoryItemToAdjust4.percent = 22
