...
--percent = 7.5, -- the percentage will need to be substracted from an existing field in the category
--}

local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomPoliceSedanSlot")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomPoliceItems")
...
categoryItemToAdjust2.percent = 17
