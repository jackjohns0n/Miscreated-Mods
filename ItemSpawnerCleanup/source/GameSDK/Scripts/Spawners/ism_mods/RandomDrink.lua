...
local newItem = {
  ...
  percent = 13, -- the percentage will need to be substracted from an existing field in the category
}
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomRottenVeggie")
local categoryItemToAdjust3 = FindInTable(categoryToAdjust.classes, "class", "EnergyDrinkCan")
