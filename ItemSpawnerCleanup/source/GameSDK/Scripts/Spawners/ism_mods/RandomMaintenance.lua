...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomMaintenance")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "ElectricalParts")
local categoryItemToAdjust3 = FindInTable(categoryToAdjust.classes, "class", "Oil")
...
categoryItemToAdjust3.percent = 10
