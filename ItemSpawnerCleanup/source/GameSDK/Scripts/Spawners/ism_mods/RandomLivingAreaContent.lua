...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomLivingAreaContent")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomCraftingGuide")
local categoryItemToAdjust3 = FindInTable(categoryToAdjust.classes, "category", "RandomClothes")
local categoryItemToAdjust4 = FindInTable(categoryToAdjust.classes, "category", "RandomAmmo")
local categoryItemToAdjust5 = FindInTable(categoryToAdjust.classes, "category", "RandomPistol")
...
categoryItemToAdjust3.percent = 31
categoryItemToAdjust4.percent = 27
categoryItemToAdjust5.percent = 27
