...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomHospitalContentMedium")
local categoryItemToAdjust = FindInTable(categoryToAdjust.classes, "class", "camping_lantern") -- could also search for fitting "class" instead "category"
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "camping_water_jug") 
...
categoryItemToAdjust2.percent = 5
