...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomKitchenContent")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomSeeds")
local categoryItemToAdjust3 = FindInTable(categoryToAdjust.classes, "class", "AmcoinLedger")
local categoryItemToAdjust4 = FindInTable(categoryToAdjust.classes, "category", "RandomFireStarter")
local categoryItemToAdjust5 = FindInTable(categoryToAdjust.classes, "category", "RandomAmmo")
...
categoryItemToAdjust4.percent = 13
categoryItemToAdjust5.percent = 24
