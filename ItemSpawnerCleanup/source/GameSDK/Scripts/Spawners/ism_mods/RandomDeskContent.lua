...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomDeskContent")
...
local categoryItemToAdjust4 = FindInTable(categoryToAdjust.classes, "category", "RandomSeeds")
...
categoryItemToAdjust5.percent = 15
