...
local newItem = {
  ...
  percent = 14, -- the percentage will need to be substracted from an existing field in the category
}

local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomMilitaryFootlockerContent")
...
local categoryItemToAdjust4 = FindInTable(categoryToAdjust.classes, "class", "MRE")
...
categoryItemToAdjust4.percent = 5
