...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomF100TruckContents")
local categoryItemToAdjust = FindInTable(categoryToAdjust.classes, "category", "RandomRanged") -- could also search for fitting "class" instead "category"
...
categoryItemToAdjust.percent = 7
