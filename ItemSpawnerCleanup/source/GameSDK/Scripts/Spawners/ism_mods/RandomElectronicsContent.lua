...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomElectronicsContent")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "Amalgaduino")
...
categoryItemToAdjust2.percent = 25
