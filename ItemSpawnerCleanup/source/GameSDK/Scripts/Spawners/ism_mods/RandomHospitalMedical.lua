...
local categoryToAdjust = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomHospitalMedical")
local categoryItemToAdjust = FindInTable(categoryToAdjust.classes, "class", "guide_medical_bandages") -- could also search for fitting "class" instead "category"
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "category", "RandomHospitalBandage")
...
categoryItemToAdjust2.percent = 21
